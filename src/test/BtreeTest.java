...
class BtreeTest {
	...
	void insertTest() {
		...
		Assert.assertEquals(node1Values, b.getRoot().getValeurs().get(0).getFilsG().getValeurs().get(0).getFilsG().getValeurs());
		Assert.assertEquals(node2Values, b.getRoot().getValeurs().get(0).getFilsG().getValeurs().get(1).getFilsG().getValeurs());
		Assert.assertEquals(node3Values, b.getRoot().getValeurs().get(0).getFilsG().getValeurs().get(1).getFilsD().getValeurs());
		Assert.assertEquals(node4Values, b.getRoot().getValeurs().get(0).getFilsD().getValeurs().get(0).getFilsG().getValeurs());
		Assert.assertEquals(node5Values, b.getRoot().getValeurs().get(0).getFilsD().getValeurs().get(1).getFilsG().getValeurs());
		Assert.assertEquals(node6Values, b.getRoot().getValeurs().get(0).getFilsD().getValeurs().get(1).getFilsD().getValeurs());
